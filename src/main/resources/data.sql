...
UNION ALL
SELECT 'LOT-VAXIGRIP-2024-001', v.id, 5000, 4200, '2026-01-10', '2027-06-30', 'Sanofi Pasteur Vietnam', '2026-01-15', 'AVAILABLE', NOW()
FROM vaccines v WHERE v.code = 'FLU-VAXIGRIP'
UNION ALL
SELECT 'LOT-MMR-2024-001', v.id, 3000, 2800, '2026-01-01', '2027-12-31', 'Merck Vietnam', '2026-01-05', 'AVAILABLE', NOW()
FROM vaccines v WHERE v.code = 'MMR'
UNION ALL
SELECT 'LOT-HEPB-2024-001', v.id, 4000, 3800, '2026-01-01', '2027-12-31', 'GSK Vietnam', '2026-01-05', 'AVAILABLE', NOW()
FROM vaccines v WHERE v.code = 'HEP-B'
UNION ALL
SELECT 'LOT-HPV-G9-2024-001', v.id, 2500, 2300, '2026-01-01', '2027-12-31', 'Merck Vietnam', '2026-01-05', 'AVAILABLE', NOW()
FROM vaccines v WHERE v.code = 'HPV-GARDASIL9'
UNION ALL
SELECT 'LOT-DPT-2024-001', v.id, 3500, 3300, '2026-01-01', '2027-12-31', 'Sanofi Pasteur Vietnam', '2026-01-05', 'AVAILABLE', NOW()
